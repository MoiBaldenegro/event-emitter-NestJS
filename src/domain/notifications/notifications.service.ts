...
export class NotificationsService {
  ...
  async sendNotification(payload: accountCreatedPayload) {
    ...
    console.log(
      `Gracias por tu registro. ${name}, espero esta demo de eventos en nestJS te sirva de mucho dejame una estrellita, y te invito a seguirme en mis redes sientete libre de contactarme para cualquier duda.`,
    );
  }
}
